...
#ifdef SLIMBOY
#define RED_LED 9   /**< The pin number for the red color in the RGB LED. */
#define GREEN_LED 7 /**< The pin number for the greem color in the RGB LED. */
#define BLUE_LED 8   /**< The pin number for the blue color in the RGB LED. */

#define RED_LED_PORT PORTB
#define RED_LED_BIT PORTB1
...
#ifdef SLIMBOY
#define PIN_SPEAKER_1 3  /**< The pin number of the first lead of the speaker */
...
#define SPEAKER_1_BIT PORTD3

#define SPEAKER_2_PORT PORTD
#define SPEAKER_2_DDR DDRD
#define SPEAKER_2_BIT PORTD5
